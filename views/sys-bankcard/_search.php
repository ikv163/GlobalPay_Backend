...
/* @var $model app\models\SysBankcardSearch */
...
<div class="sys-bankcard-search">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <?= $form->field($model, 'card_status')->dropDownList(array('' => '所有状态') + SysBankcard::$BankCardStatusRel) ?>
        </div>
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
            <?= $form->field($model, 'card_owner')->dropDownList(array('' => '所有') + \Yii::t('app', 'sys_bankcard_owner')) ?>
        </div>
