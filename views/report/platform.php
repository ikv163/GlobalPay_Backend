...
$this->title = Yii::t('app/menu', 'Platform_Report');
...
<div class="report-index">
    ...
    <?php echo $this->render('_search', ['model' => $searchModel, 'action' => 'platform', 'userType' => Report::$ReportTypePlatform]); ?>
    <button type="button" class="btn btn-success calcReport">统计报表</button>
    <button type="button" class="btn btn-success export">导出平台报表</button>
    <?= GridView::widget([
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on('click', '.export', function () {
            ...
            windows = window.open('/report/export-platform?' + t);
        });
    })
</script>
