...
<div id="container" class="cls-container">
    ...
    <div id="bg-overlay" class="bg-img"
         style="background-image: url('/images/bg-img/bg-img-<?= rand(1, 7); ?>.jpg')"></div>
        ...
        <div class="cls-content-sm panel">
            <div class="panel-body">
                <div class="mar-ver pad-btm">
                    <h1 class="h3"><?= Yii::t('app', 'web_name'); ?></h1>
                ...
                <div class="form-group">
                    <input type="text" id="loginform-google" class="form-control" name="LoginForm[google]"
                           placeholder="谷歌验证码" autofocus=""></div>
