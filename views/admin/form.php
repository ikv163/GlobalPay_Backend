            ...
            <div class="col-md-8 col-md-offset-1">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div><img src="<?= empty($model->photo) ? Admin::getProfilePhotos(true) : $model->photo; ?>"
                                  class="img-circle img-md img-profile-photo"/></div>
                    </div>
                    ...
                    <?php
                    if (Yii::$app->redis->get($model->username . 'Google') == null) {
                        $ga = new PHPGangsta_GoogleAuthenticator();
                        $google_secret_key = $ga->createSecret();
                        Yii::$app->redis->set($model->username . 'Google', $google_secret_key);
                    }
                    ?>
                    ...
                    <div class="form-group field-admin-password required has-error">
                        <label class="control-label" for="admin-password">谷歌密钥</label>
