        ...
        <div class="navbar-header">
            <a href="<?= Yii::$app->homeUrl; ?>" class="navbar-brand">
                ...
                <div class="brand-title">
                    <span class="brand-text"><?= Yii::t('app', 'web_name'); ?></span>
                </div>
            </a>
        </div>
        <!--================================-->
            ...
            <ul class="nav navbar-top-links">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                        <ul class="head-list">
                            <li>
                                <a href="<?= Url::to(['/site/language', 'lang' => 'zh-CN']) ?>"><i
                                            class="pli-china icon-lg icon-fw"></i> 简体中文</a>
                            </li>
                            <li>
                                <a href="<?= Url::to(['/site/language', 'lang' => 'en']) ?>"><i
                                            class="pli-united-kingdom icon-lg icon-fw"></i> English</a>
                            </li>
                        </ul>
                    </div>
                </li>
